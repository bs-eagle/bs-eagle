  ...
  namespace wells
    ...
    class BS_API_PLUGIN well_controller : public objbase
      ...
      public:
        ...
        typedef wells::type_helper::item_rhs_block_t      item_rhs_block_t;
        typedef wells::type_helper::item_ww_block_t       item_ww_block_t;
        typedef wells::type_helper::item_q_rate_t         item_q_rate_t;
        typedef wells::type_helper::item_q_rate_inflow_t  item_q_rate_inflow_t;
        typedef wells::type_helper::item_gas_rate_t       item_gas_rate_t;
