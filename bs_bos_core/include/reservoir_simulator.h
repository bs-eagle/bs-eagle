...
namespace blue_sky
{
  ...
  class BS_API_PLUGIN reservoir_simulator : public bs_node
    ...
    public:
      ...
      typedef data_manager dm_t;                 //!< data_manager type
      ...
      typedef linear_solver_base solver_t;             //!< linear_solver type
      ...
      typedef strategy_t::item_t           item_t;               //!< item type
      typedef strategy_t::index_t          index_t;              //!< index type
      typedef strategy_t::item_array_t     item_array_t;         //!< array of items type
      typedef strategy_t::index_array_t    index_array_t;        //!< array of indexes type
      ...
      typedef keyword_manager keyword_manager_t;    //!< keyword_manager type
      typedef smart_ptr <keyword_manager_t, true >  sp_keyword_manager_t; //!< smart_ptr to keyword_manager type

      typedef jacobian_matrix jmatrix_t;            //!< jacobian_matrix type
