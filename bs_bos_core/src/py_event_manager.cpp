...
namespace python {
  ...
  py_export_event_manager ()
  {
    ...
    typedef std::list <smart_ptr <event_base> > event_list;

    export_event_list <event_list> ("event_list");
    export_event_map <std::map <boost::posix_time::ptime, event_list> > ("event_map");
