...
namespace blue_sky
  ...
  BLUE_SKY_TYPE_IMPL_T_EXT (2, (bos_val_table <std::string, facility_manager::sp_facility_t>), 1, (objbase), "bos_map<str, facility>", "map of str and facility", "map of str and facility", false);
  ...
  //facility_manager::well_iterator_t
  //facility_manager::wells_begin ()
  //  {
  //    return facility_list_->begin ();
  //    //const sp_facility_map_t &locked_list (facility_list_);
  //    //return well_iterator_t (locked_list, locked_list->begin ());
  ...
  unsigned int
  facility_manager::wells_size () const {
  ...
  BLUE_SKY_TYPE_IMPL (facility_manager, objbase, "facility_manager", "facility_manager", "facility_manager");
  //////////////////////////////////////////////////////////////////////////
  ...
  facility_manager_register_type (const blue_sky::plugin_descriptor &pd)
  {
    ...
    res &= BS_KERNEL.register_type (pd, facility_manager::bs_type ());
    BS_ASSERT (res);
