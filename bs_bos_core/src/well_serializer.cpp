...
namespace blue_sky
  ...
  namespace wells
    ...
    BLUE_SKY_TYPE_IMPL (well_serializer, data_serializer, "well_serializer", "well_serializer", "well_serializer");
    ...
    well_serializer_register_type (const plugin_descriptor &pd)
    {
      ...
      res &= BS_KERNEL.register_type (pd, well_serializer::bs_type ());
      BS_ASSERT (res);
