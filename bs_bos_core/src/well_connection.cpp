...
namespace blue_sky
  ...
  namespace wells
    ...
    shared_vector <strategy_t::rhs_item_t>
    ...
    BLUE_SKY_TYPE_IMPL (connection, objbase, "well_connection", "BOS_Core well connection class", "BOS_Core well connection class")
