/**
 * \file bicgstab_solver.h
 * \brief BiCGStab linear solver
 * \author SalimgareevaEM
 * \date
 * */
#ifndef BS_BICGSTAB_LINEAR_SOLVER_H_
#define BS_BICGSTAB_LINEAR_SOLVER_H_
...
namespace blue_sky
  ...
  */
  ...
  class BS_API_PLUGIN bicgstab_solver : public lsolver_iface<strategy_t>
    {
    ...
    protected:
      ...
      sp_fp_array_t     sp_p;
      sp_fp_array_t     sp_phat;
      sp_fp_array_t     sp_s;
      sp_fp_array_t     sp_shat;
      sp_fp_array_t     sp_t;
      sp_fp_array_t     sp_v;
      sp_fp_array_t     sp_r;
