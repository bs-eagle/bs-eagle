...
namespace blue_sky
  ...
  BLUE_SKY_TYPE_IMPL (mesh_grdecl_keywords, keyword_info_base, 
    "BOS Core mesh_grdecl keyword_info", "MESH_GRDECL", "Reservoir sumulator structured mesh grdecl keywords")
