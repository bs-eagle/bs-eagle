...
#ifndef __PMIS2_COARSE_H
#define __PMIS2_COARSE_H
...
namespace blue_sky
{
   ...
   */
  class BS_API_PLUGIN pmis2_coarse: public amg_coarse_iface
    {
      //! bcsr matrix
      typedef bcsr_amg_matrix_iface                             bcsr_t;
      typedef smart_ptr<bcsr_t, true>                           sp_bcsr_t;
      //! this_t
      typedef pmis2_coarse                                      this_t;

      BLUE_SKY_TYPE_DECL (pmis2_coarse);
    //-----------------------------------------
    //  METHODS
    //-----------------------------------------
    public:
      ...
      virtual t_long build (sp_bcsr_t a_matrix, 
                            ...
                            spv_long s_markers);
      //! destructor
      virtual ~pmis2_coarse ()
        {}

#ifdef BSPY_EXPORTING_PLUGIN
      virtual std::string py_str () const
        {
          return std::string ("PMIS2 grid coasering builder.");
        }
