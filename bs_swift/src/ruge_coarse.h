/** 
 * @file ruge_coarse.h
 * @brief implimentation of Ruge coarsering
 * @author 
 * @version 
 * @date 2010-03-03
 */
#ifndef __RUGE_COARSE_H
#define __RUGE_COARSE_H
...
namespace blue_sky
{
   ...
   */
  class BS_API_PLUGIN ruge_coarse: public amg_coarse_iface
    {
      //! bcsr matrix
      typedef bcsr_amg_matrix_iface                             bcsr_t;
      typedef smart_ptr<bcsr_t, true>                           sp_bcsr_t;
      //! this_t
      typedef ruge_coarse                                       this_t;

      BLUE_SKY_TYPE_DECL (ruge_coarse);
    //-----------------------------------------
    //  METHODS
    //-----------------------------------------
    public:
      ...
      virtual std::string py_str () const
        {
          return std::string ("Ruge grid coasering builder.");
        }
