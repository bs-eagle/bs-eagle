...
namespace blue_sky
  ...
  class BS_API_PLUGIN rocktab_table  : public bs_table <strategy_t>
    ...
    public:
      ...
      ~rocktab_table();
      //! interpolate method
      inline void interpolate(item_t pressure,
                              item_t *phi_m,
                              item_t *dp_phi_m,
                              item_t *truns_m,
                              item_t *dp_truns_m
  ...
  template <class strategy_t>
  inline void
  rocktab_table <strategy_t>::interpolate (item_t pressure,    //!< pressure value
      item_t *phi_m,      //!< porosity multiplier
      item_t *dp_phi_m,   //!< pressure derivation of dp_phi_m
      item_t *truns_m,    //!< transmissibility multiplier
      item_t *dp_truns_m  //!< pressure derivation of transmissibility
                                          )
  {
